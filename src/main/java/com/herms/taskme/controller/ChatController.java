...
public class ChatController {
	...
	public MessageDTO sendMessage(@Payload MessageDTO chatMessage, @DestinationVariable("chatRoomId") String chatRoomId) {
		if(messageService.addMessage(chatMessage) != null) {
